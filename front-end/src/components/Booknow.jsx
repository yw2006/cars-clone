        ...
        <div className='card-details-main h-100 p-3'>
            ...
            <div className='container-fluid seconddiv bg-white mt-3 mb-5'>
                ...
                <div className='row m-3 second'>
                    ...
                    <div className='col-md-3 carttotal w-25  p-3 d-flex flex-column h-25'>
                        <div className='col-xs-12'>
                            <h4 className='header text-center'>Booking Total</h4>
                        </div>
                        <div className='col-xs-12 mt-3 text-center'>
                            <h6 className='d-inline text-center mt-2'>Car Name</h6>
                        </div>
                        <div className='col-xs-12 mt-3 text-center'>
                            <h6 className='d-inline text-center'>{bookdetails.name}</h6>
                        </div>
                        <div className='col-xs-12 mt-3 text-center'>
                            <h6 className='d-inline text-center mt-2'>Total</h6>
                        </div>
                        <div className='col-xs-12 mt-3 text-center'>
