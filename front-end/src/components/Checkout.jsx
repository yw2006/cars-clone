    ...
    return (
        <div className='card-details-main h-100 p-3'>
            ...
            <div className='container-fluid seconddiv bg-white '>
                ...
                <div >
                    <div className='m-auto text-center'><svg className='m-auto true-icon  text-center' xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill=" rgb(39, 39, 255)" class="bi bi-check2-circle" viewBox="0 0 16 16">
                        <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0" />
                        <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z" />
                    </svg></div>
                    <div className='mb-5'>
                        <h1 className='m-auto text-center'>Your order is completed!</h1>
                        <p className='m-auto text-center'>Thank you. Your order has been received.</p>
                    </div>
