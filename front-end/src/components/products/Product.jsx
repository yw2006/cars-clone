    ...
    return (
        <div className="card  " style={{ backgroundColor: '#040C2E', color: 'white', borderRadius: '18px' ,border:"none"}}>
            ...
            <div className="card-body ">
                ...
                <a href={`#/price=${props.price}`} className=" card-link btn " style={{ color: 'white' }}>view details <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right" viewBox="0 0 16 16">
...
export function P_Sedan(props) {
    return (
        <div className="card  " style={{ backgroundColor: '#040C2E', color: 'white', borderRadius: '18px' }}>
            <img src={props.image} className="card-img-top product--image " style={{ borderRadius: '18px' }} alt="..." />
...
export function P_Convertible(props) {
    return (
        <div className="card  " style={{ backgroundColor: '#040C2E', color: 'white', borderRadius: '18px' }}>
            <img src={props.image} className="card-img-top product--image " style={{ borderRadius: '18px' }} alt="..." />
