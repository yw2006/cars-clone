    ...
    return (
        <div className="card  " style={{ backgroundColor: '#040C2E', color: 'white', borderRadius: '18px', border: "none" }}>
            ...
            <div className="card-body ">
                ...
                <a href={`/CardDetails/${props.id}`} className=" card-link btn " style={{ color: 'white' }}>view details <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right" viewBox="0 0 16 16">
